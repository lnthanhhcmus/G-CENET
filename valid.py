...
def execute_valid(args, total_data, model,
    ...
    for batch_data in utils.make_batch(data,
        ...
        with torch.no_grad():
            ...
            # _, _, \
            # rank_2, cur_loss2, \
            # rank_3, cur_loss3, ce_all_acc = model(batch_data, 'Valid', args.entity, total_data)

            rank, cur_loss = model(batch_data, 'Valid', args.entity, total_data)
